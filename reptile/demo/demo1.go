...
const (
	...
	login_url           string = "https://xiaoyaojp.com/forum-130-1.html"
	verify_code_url     string = "http://passport.jikexueyuan.com/sso/verify"
	post_login_info_url string = "https://xiaoyaojp.com/member.php?mod=logging&action=login&loginsubmit=yes&frommessage&loginhash=LjSeu&inajax=1"
	username            string = "dong1hang"
	password            string = "331801363"
)
...
func login() {
	...
	postValues.Add("formhash", "4efa916d")
	//postValues.Add("expire", "7")
	postValues.Add("referer", "https://xiaoyaojp.com/forum-130-1.html")
